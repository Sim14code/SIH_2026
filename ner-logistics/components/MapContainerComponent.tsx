    ...
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-3 right-3 z-[1000] flex flex-col gap-2 bg-slate-900/90 backdrop-blur-sm rounded-xl p-3 border border-slate-700/50 shadow-xl min-w-[190px]">
        ...
        <div className="mt-2 pt-2 border-t border-slate-700">
          <button
            onClick={() => {
              alert('Downloading offline map data... (Prototype)');
            }}
            className="w-full flex items-center justify-center gap-2 py-1.5 px-2 bg-indigo-500/20 hover:bg-indigo-500/40 text-indigo-300 text-xs font-semibold rounded-lg transition-colors border border-indigo-500/30"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
            </svg>
            Download Offline SOS
          </button>
        </div>
      </div>
